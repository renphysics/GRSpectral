...
(*
GRSpectral v0.2, by Jie Ren, 2024/7/6
https://github.com/renphysics/GRSpectral
...
unitNormal[surfEq_,signature:1|-1:1]:=(normal=covariant[surfEq];
unitnormal=normal/Sqrt[signature norm[normal]])


hypersurf[signature:1|-1:1]:=(projector=metric-signature unitnormal**unitnormal//Simplify; (*induced metric*)
extrinsic=1/2 Lie[raise[unitnormal],projector];
extrinsictrace=contract[extrinsic];)
hypersurf[surfEq_,signature:1|-1:1]:=(unitNormal[surfEq,signature]; hypersurf[signature];)
